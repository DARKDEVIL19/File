...
\033[1;93m--------------------------------------------------
  \033[1;32mF4C3B00K  : FUCK HACKER
  \033[1;32mY0UTUB3   : FUCK
  \033[1;32mV3RS10N   : 10.10
  \033[1;32m0WN3R     : OMI VAU 
--------------------------------------------------
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://www.facebook.com/profile.php?id=100092013160584');menu()
...
def menu_apikey():
  ...
  print("""\033[1;37m
    ...
    \033[1;32m_______________________________________
\033[1;37m[-] AUTHOR    :\033[1;32mFUCK HACKER 
\033[1;37m[-] GITHUB    :\033[1;32m FUCK 
...
==================================================   """)
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system('xdg-openhttps://github.com/DARKDEVIL19/approval/tree/main')
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def tnx():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "_".join(uuid)
  server = requests.get('https://github.com/DARKDEVIL19/approval/tree/main').text
  ...
  print("\x1b[1;97m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/DARKDEVIL19/approval/tree/main").text
    if id in httpCaht:
      print("\033[1;97m   YOUR TOKEN APROVED ðŸ¥€ ");time.sleep(2)
      msg = str(os.geteuid())
      time.sleep(0.5)
